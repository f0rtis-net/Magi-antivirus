...
inline void ImGui::FileBrowser::Display( )
{
	...
	if ( flags_ & ImGuiFileBrowserFlags_NoModal )
	{
		...
		ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize : 0 ) )
	{
		return;
	}
	...
	SetCursorPosX( 5 );
	InputTextEx( "##searcher", NULL, search_buffer, sizeof( search_buffer ), ImVec2( 150, 31 ), ImGuiInputTextFlags_None );
	...
	{
		BeginChild( "", ImVec2( 0, -reserveHeight - 5 ), true,
...
inline std::string utf16to8( const std::wstring& input )
{
	std::string out;
